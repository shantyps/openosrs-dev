...
public abstract class Actor extends Renderable {
	...
	Actor() {
		...
		this.showPublicPlayerChat = false; // L: 33
		...
		this.currentSequenceFrameIndex = 0; // L: 56
		...
		this.recolourStartCycle = -1; // L: 71
		this.recolourEndCycle = -1; // L: 72

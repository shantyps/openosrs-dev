...
public final class ItemLayer {
	...
	static final void updateActorSequence(Actor var0, int var1) {
		...
		int var4;
		int var11;
		if (var0.exactMoveArrive1Cycle >= Client.cycle) { // L: 4624
			var11 = Math.max(1, var0.exactMoveArrive1Cycle - Client.cycle); // L: 4625
			var3 = var0.field1120 * 64 + var0.exactMoveDeltaX1 * 128; // L: 4626
			var4 = var0.field1120 * 64 + var0.exactMoveDeltaY1 * 128; // L: 4627
			var0.x += (var3 - var0.x) / var11; // L: 4628
			var0.y += (var4 - var0.y) / var11; // L: 4629
			var0.field1117 = 0; // L: 4630
			var0.orientation = var0.exactMoveDirection; // L: 4631
		} else if (var0.exactMoveArrive2Cycle >= Client.cycle) { // L: 4633
			...
			if (var0.pathLength == 0) { // L: 4636
				...
				label410: {
					...
					MoveSpeed var6 = var0.field1153[var0.pathLength - 1]; // L: 4667
					if (var4 - var11 <= 256 && var4 - var11 >= -256 && var5 - var3 <= 256 && var5 - var3 >= -256) { // L: 4668
						...
						if (var6 == MoveSpeed.field2122) { // L: 4703
							var9 <<= 1;
						} else if (var6 == MoveSpeed.field2120) { // L: 4704
							var9 >>= 1;
						}
		...
		if (var0.x < 128 || var0.y < 128 || var0.x >= 13184 || var0.y >= 13184) { // L: 4729
			...
			var0.exactMoveArrive1Cycle = 0; // L: 4732
			var0.exactMoveArrive2Cycle = 0; // L: 4733
		...
		if (class340.localPlayer == var0 && (var0.x < 1536 || var0.y < 1536 || var0.x >= 11776 || var0.y >= 11776)) { // L: 4738 4739
			...
			var0.exactMoveArrive1Cycle = 0; // L: 4742
			var0.exactMoveArrive2Cycle = 0; // L: 4743
		...
		if (var0.field1149 != 0) { // L: 4750
			...
			if (var0.facedDirection != -1 && (var0.pathLength == 0 || var0.field1117 > 0)) { // L: 4765
				var0.orientation = var0.facedDirection; // L: 4766
				var0.facedDirection = -1; // L: 4767
			}

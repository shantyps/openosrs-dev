...
public final class ItemLayer {
	...
	static final void updateActorSequence(Actor var0, int var1) {
		...
		if (var0.exactMoveArrive1Cycle >= Client.cycle) {
			...
			var3 = var0.field1120 * 64 + var0.exactMoveDeltaX1 * 128;
			var4 = var0.field1120 * 64 + var0.exactMoveDeltaY1 * 128;
			...
			if (var0.pathLength == 0) {
				...
				label410: {
					...
					if (var4 - var11 <= 256 && var4 - var11 >= -256 && var5 - var3 <= 256 && var5 - var3 >= -256) {
						...
						if (var6 == MoveSpeed.field2122) {
							var9 <<= 1;
						} else if (var6 == MoveSpeed.field2120) {
							var9 >>= 1;
						}
		...
		if (var0.field1149 != 0) {
			...
			if (var0.facedDirection != -1 && (var0.pathLength == 0 || var0.field1117 > 0)) {

			...
			if (--field517 + 1 <= 0) {
				try {
					if (js5ConnectState == 0) {
						ScriptEvent.js5SocketTask = GameEngine.taskHandler.newSocketTask(MoveSpeed.worldHost, class129.currentPort);
						++js5ConnectState;
					}
		...
		try {
			...
			if (loginState == 1) {
				if (class334.socketTask == null) {
					class334.socketTask = GameEngine.taskHandler.newSocketTask(MoveSpeed.worldHost, class129.currentPort);
				}
				...
				if (loginState != 16) {
					...
					if (((AbstractSocket)var1).available() >= packetWriter.serverPacketLength) {
						...
						for (var34 = 0; var34 < 2048; ++var34) {
							...
							Players.field1246[var34] = MoveSpeed.field2123;
						}
													...
													do {
														...
														if (var40 == null) {
															...
															if (field724) {
																...
																var4 = class167.cameraMoveToX * 128 + 64;
																var5 = VarpDefinition.cameraMoveToY * 128 + 64;
																var6 = FaceNormal.getTileHeight(var4, var5, class20.Client_plane) - UserComparator9.cameraMoveToHeight;
																class1.method12(var4, var6, var5);
																var4 = PlayerComposition.cameraLookAtX * 128 + 64;
																var5 = MusicPatchNode.cameraLookAtY * 128 + 64;
																var6 = FaceNormal.getTileHeight(var4, var5, class20.Client_plane) - ModeWhere.cameraLookAtHeight;
		...
		if (var2 == null) {
			...
			try {
				...
				if (ServerPacket.field3027 == var1.serverPacket && isCameraLocked) {
					field724 = true;
					Renderable.cameraMoveToSpeed = var3.readUnsignedByte();
					ItemComposition.cameraMoveToAcceleration = var3.readUnsignedByte();
					WorldMapSection1.cameraLookAtSpeed = var3.readUnsignedByte();
					ChatChannel.cameraLookAtAcceleration = var3.readUnsignedByte();
				...
				if (ServerPacket.field2942 == var1.serverPacket) {
					isCameraLocked = true;
					field724 = false;
					PlayerComposition.cameraLookAtX = var3.readUnsignedByte();
					MusicPatchNode.cameraLookAtY = var3.readUnsignedByte();
					ModeWhere.cameraLookAtHeight = var3.readUnsignedShort();
					WorldMapSection1.cameraLookAtSpeed = var3.readUnsignedByte();
					ChatChannel.cameraLookAtAcceleration = var3.readUnsignedByte();
					if (ChatChannel.cameraLookAtAcceleration >= 100) {
						var17 = PlayerComposition.cameraLookAtX * 128 + 64;
						var5 = MusicPatchNode.cameraLookAtY * 128 + 64;
						var6 = FaceNormal.getTileHeight(var17, var5, class20.Client_plane) - ModeWhere.cameraLookAtHeight;
				...
				if (ServerPacket.field3007 == var1.serverPacket) {
					isCameraLocked = true;
					field724 = false;
					class167.cameraMoveToX = var3.readUnsignedByte();
					VarpDefinition.cameraMoveToY = var3.readUnsignedByte();
					UserComparator9.cameraMoveToHeight = var3.readUnsignedShort();
					Renderable.cameraMoveToSpeed = var3.readUnsignedByte();
					ItemComposition.cameraMoveToAcceleration = var3.readUnsignedByte();
					if (ItemComposition.cameraMoveToAcceleration >= 100) {
						UserComparator7.cameraX = class167.cameraMoveToX * 128 + 64;
						UserComparator10.cameraZ = VarpDefinition.cameraMoveToY * 128 + 64;
						AbstractByteArrayCopier.cameraY = FaceNormal.getTileHeight(UserComparator7.cameraX, UserComparator10.cameraZ, class20.Client_plane) - UserComparator9.cameraMoveToHeight;
					}
				...
				if (ServerPacket.field2983 == var1.serverPacket) {
					...
					ChatChannel.ifOpenSub(var6, var17, var5);
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field2953 == var1.serverPacket) {
					...
					var25.modelRotation = var6 + (var5 << 16);
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3003 == var1.serverPacket) {
					...
					class315.playJingle(var5, var17);
					var1.serverPacket = null;
					return true;
				}
	...
	public final void init() {
		try {
			if (this.checkHost()) {
				...
				isLowDetail = false;
				MoveSpeed.worldHost = this.getCodeBase().getHost();

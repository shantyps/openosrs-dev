...
public class class1 implements Callable {
	...
	static final void method12(int var0, int var1, int var2) {
		if (UserComparator7.cameraX < var0) { // L: 4548
			UserComparator7.cameraX = (var0 - UserComparator7.cameraX) * ItemComposition.cameraMoveToAcceleration / 1000 + UserComparator7.cameraX + Renderable.cameraMoveToSpeed; // L: 4549
		...
		if (UserComparator7.cameraX > var0) { // L: 4552
			UserComparator7.cameraX -= (UserComparator7.cameraX - var0) * ItemComposition.cameraMoveToAcceleration / 1000 + Renderable.cameraMoveToSpeed; // L: 4553
		...
		if (AbstractByteArrayCopier.cameraY < var1) { // L: 4556
			AbstractByteArrayCopier.cameraY = (var1 - AbstractByteArrayCopier.cameraY) * ItemComposition.cameraMoveToAcceleration / 1000 + AbstractByteArrayCopier.cameraY + Renderable.cameraMoveToSpeed; // L: 4557
		...
		if (AbstractByteArrayCopier.cameraY > var1) { // L: 4560
			AbstractByteArrayCopier.cameraY -= (AbstractByteArrayCopier.cameraY - var1) * ItemComposition.cameraMoveToAcceleration / 1000 + Renderable.cameraMoveToSpeed; // L: 4561
		...
		if (UserComparator10.cameraZ < var2) { // L: 4564
			UserComparator10.cameraZ = (var2 - UserComparator10.cameraZ) * ItemComposition.cameraMoveToAcceleration / 1000 + UserComparator10.cameraZ + Renderable.cameraMoveToSpeed; // L: 4565
		...
		if (UserComparator10.cameraZ > var2) { // L: 4568
			UserComparator10.cameraZ -= (UserComparator10.cameraZ - var2) * ItemComposition.cameraMoveToAcceleration / 1000 + Renderable.cameraMoveToSpeed; // L: 4569

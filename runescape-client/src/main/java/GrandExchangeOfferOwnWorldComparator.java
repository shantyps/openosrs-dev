...
public class GrandExchangeOfferOwnWorldComparator implements Comparator {
	...
	static final void method1148() {
		...
		if (UserComparator7.cameraX == class127.field1498 && AbstractByteArrayCopier.cameraY == class117.field1433 && class33.field243 == UserComparator10.cameraZ && class142.field1615 == UserComparator7.cameraPitch && ApproximateRouteStrategy.field460 == class379.cameraYaw) {
			...
			PlayerComposition.cameraLookAtX = 0;
			MusicPatchNode.cameraLookAtY = 0;
			ModeWhere.cameraLookAtHeight = 0;
			WorldMapSection1.cameraLookAtSpeed = 0;
			ChatChannel.cameraLookAtAcceleration = 0;
			ItemComposition.cameraMoveToAcceleration = 0;
			Renderable.cameraMoveToSpeed = 0;
			class167.cameraMoveToX = 0;
			VarpDefinition.cameraMoveToY = 0;
			UserComparator9.cameraMoveToHeight = 0;
		}
		...
		if (var3 > Client.npcCount) {
			...
			for (var4 = 0; var4 < var3; ++var4) {
				...
				if (var7 == 0) {
					...
					if (var8 == 0) {
						...
						var16.method2319(var9, MoveSpeed.field2123);
						...
						if (var2.readBits(1) == 1) {
							var9 = var2.readBits(3);
							var16.method2319(var9, MoveSpeed.field2122);
							var10 = var2.readBits(3);
							var16.method2319(var10, MoveSpeed.field2122);
						} else {
							var9 = var2.readBits(3);
							var16.method2319(var9, MoveSpeed.field2120);
						}
			...
			for (var14 = 0; var14 < Client.field520; ++var14) {
				...
				if ((var5 & 2) != 0) {
					...
					var15.spotAnimationStartCycle = (var6 & 65535) + Client.cycle;
					var15.spotAnimationFrame = 0;
					var15.spotAnimationFrameCycle = 0;
					if (var15.spotAnimationStartCycle > Client.cycle) {
				...
				if ((var5 & 64) != 0) {
					...
					if (var6 == var15.sequence && var6 != -1) {
						...
						if (var8 == 1) {
							...
							var15.currentSequenceFrameIndex = 0;
						}
				...
				if (class12.field72 && (var5 & 1024) != 0 || !class12.field72 && (var5 & 4) != 0) {
					var15.exactMoveDeltaX1 = var1.method7396();
					var15.exactMoveDeltaY1 = var1.readByte();
					var15.exactMoveDeltaX2 = var1.method7396();
					var15.exactMoveDeltaY2 = var1.readByte();
					var15.exactMoveArrive1Cycle = var1.method7403() + Client.cycle;
					var15.exactMoveArrive2Cycle = var1.readUnsignedShort() + Client.cycle;
					var15.exactMoveDirection = var1.method7403();
					var15.pathLength = 1;
					var15.field1098 = 0;
					var15.exactMoveDeltaX1 += var15.pathX[0];
					var15.exactMoveDeltaY1 += var15.pathY[0];
					var15.exactMoveDeltaX2 += var15.pathX[0];
					var15.exactMoveDeltaY2 += var15.pathY[0];
				}

...
public class GrandExchangeOfferOwnWorldComparator implements Comparator {
	...
	static final void method1148() {
		...
		if (UserComparator7.cameraX == class127.field1498 && AbstractByteArrayCopier.cameraY == class117.field1433 && class33.field243 == UserComparator10.cameraZ && class142.field1615 == UserComparator7.cameraPitch && ApproximateRouteStrategy.field460 == class379.cameraYaw) { // L: 4530
			...
			PlayerComposition.cameraLookAtX = 0; // L: 4533
			MusicPatchNode.cameraLookAtY = 0; // L: 4534
			ModeWhere.cameraLookAtHeight = 0; // L: 4535
			WorldMapSection1.cameraLookAtSpeed = 0; // L: 4536
			ChatChannel.cameraLookAtAcceleration = 0; // L: 4537
			ItemComposition.cameraMoveToAcceleration = 0; // L: 4538
			Renderable.cameraMoveToSpeed = 0; // L: 4539
			class167.cameraMoveToX = 0; // L: 4540
			VarpDefinition.cameraMoveToY = 0; // L: 4541
			UserComparator9.cameraMoveToHeight = 0; // L: 4542
		}
			...
			for (var4 = 0; var4 < var3; ++var4) { // L: 8283
				...
				if (var7 == 0) { // L: 8287
					...
					if (var8 == 0) { // L: 8293
						...
						var16.method2319(var9, MoveSpeed.field2123); // L: 8303
						...
						if (var2.readBits(1) == 1) { // L: 8311
							...
							var16.method2319(var9, MoveSpeed.field2122); // L: 8313
							var10 = var2.readBits(3); // L: 8314
							var16.method2319(var10, MoveSpeed.field2122); // L: 8315
						} else {
							var9 = var2.readBits(3); // L: 8318
							var16.method2319(var9, MoveSpeed.field2120); // L: 8319
						}
			...
			for (var14 = 0; var14 < Client.field520; ++var14) { // L: 8418
				...
				if ((var5 & 8) != 0) { // L: 8426
					...
					if (var8 != 0 || var9 != 0) { // L: 8434
						var15.facedDirection = (int)(Math.atan2((double)var8, (double)var9) * 325.949D) & 2047;
					}
				}
				...
				if ((var5 & 2) != 0) { // L: 8478
					...
					var15.spotAnimationHeight = var6 >> 16; // L: 8481
					var15.spotAnimationStartCycle = (var6 & 65535) + Client.cycle; // L: 8482
					var15.spotAnimationFrame = 0; // L: 8483
					var15.spotAnimationFrameCycle = 0; // L: 8484
					if (var15.spotAnimationStartCycle > Client.cycle) { // L: 8485
				...
				if ((var5 & 64) != 0) { // L: 8491
					...
					if (var6 == var15.sequence && var6 != -1) { // L: 8495
						...
						if (var8 == 1) { // L: 8497
							...
							var15.currentSequenceFrameIndex = 0; // L: 8501
						}

						if (var8 == 2) { // L: 8503
							var15.currentSequenceFrameIndex = 0; // L: 8504
						}
						...
						var15.currentSequenceFrameIndex = 0; // L: 8512
						var15.field1098 = var15.pathLength; // L: 8513
					}
				}

				if (class12.field72 && (var5 & 1024) != 0 || !class12.field72 && (var5 & 4) != 0) { // L: 8517
					var15.exactMoveDeltaX1 = var1.method7396(); // L: 8518
					var15.exactMoveDeltaY1 = var1.readByte(); // L: 8519
					var15.exactMoveDeltaX2 = var1.method7396(); // L: 8520
					var15.exactMoveDeltaY2 = var1.readByte(); // L: 8521
					var15.exactMoveArrive1Cycle = var1.method7403() + Client.cycle; // L: 8522
					var15.exactMoveArrive2Cycle = var1.readUnsignedShort() + Client.cycle; // L: 8523
					var15.exactMoveDirection = var1.method7403(); // L: 8524
					var15.pathLength = 1; // L: 8525
					var15.field1098 = 0; // L: 8526
					var15.exactMoveDeltaX1 += var15.pathX[0]; // L: 8527
					var15.exactMoveDeltaY1 += var15.pathY[0]; // L: 8528
					var15.exactMoveDeltaX2 += var15.pathX[0]; // L: 8529
					var15.exactMoveDeltaY2 += var15.pathY[0]; // L: 8530
				}

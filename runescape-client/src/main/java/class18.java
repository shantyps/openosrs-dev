...
class class18 implements Comparator {
	...
	static final void method293(Actor var0) {
		if (var0.exactMoveArrive2Cycle == Client.cycle || var0.sequence == -1 || var0.sequenceDelay != 0 || var0.sequenceFrameCycle + 1 > UserComparator5.SequenceDefinition_get(var0.sequence).frameLengths[var0.sequenceFrame]) {
			int var1 = var0.exactMoveArrive2Cycle - var0.exactMoveArrive1Cycle;
			int var2 = Client.cycle - var0.exactMoveArrive1Cycle;
			int var3 = var0.field1120 * 64 + var0.exactMoveDeltaX1 * 128;
			int var4 = var0.field1120 * 64 + var0.exactMoveDeltaY1 * 128;
			int var5 = var0.field1120 * 64 + var0.exactMoveDeltaX2 * 128;
			int var6 = var0.field1120 * 64 + var0.exactMoveDeltaY2 * 128;

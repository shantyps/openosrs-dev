...
class class18 implements Comparator {
	...
	static final void method293(Actor var0) {
		if (var0.exactMoveArrive2Cycle == Client.cycle || var0.sequence == -1 || var0.sequenceDelay != 0 || var0.sequenceFrameCycle + 1 > UserComparator5.SequenceDefinition_get(var0.sequence).frameLengths[var0.sequenceFrame]) { // L: 4810
			int var1 = var0.exactMoveArrive2Cycle - var0.exactMoveArrive1Cycle; // L: 4811
			int var2 = Client.cycle - var0.exactMoveArrive1Cycle; // L: 4812
			int var3 = var0.field1120 * 64 + var0.exactMoveDeltaX1 * 128; // L: 4813
			int var4 = var0.field1120 * 64 + var0.exactMoveDeltaY1 * 128; // L: 4814
			int var5 = var0.field1120 * 64 + var0.exactMoveDeltaX2 * 128; // L: 4815
			int var6 = var0.field1120 * 64 + var0.exactMoveDeltaY2 * 128; // L: 4816
			var0.x = (var5 * var2 + var3 * (var1 - var2)) / var1; // L: 4817
			var0.y = (var6 * var2 + var4 * (var1 - var2)) / var1; // L: 4818
		}

		var0.field1117 = 0; // L: 4820
		var0.orientation = var0.exactMoveDirection; // L: 4821

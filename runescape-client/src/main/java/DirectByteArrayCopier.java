	...
	static final void method5328(class253 var0) {
		...
		if (class253.field2911 == var0) { // L: 7665
			...
			if (var39 >= 0 && var40 >= 0 && var39 < 103 && var40 < 103) { // L: 7674
				if (var9 == 0) { // L: 7675
					BoundaryObject var36 = class7.scene.getBoundaryObject(class20.Client_plane, var39, var40); // L: 7676
				...
				if (var9 == 1) { // L: 7686
					WallDecoration var44 = class7.scene.getWallObject(class20.Client_plane, var39, var40); // L: 7687

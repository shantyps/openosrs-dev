...
public final class Player extends Actor {
	...
	final void method2175(int var1, int var2, MoveSpeed var3) {
		...
		if (var1 >= 0 && var1 < 104 && var2 >= 0 && var2 < 104) { // L: 250
			if (super.pathX[0] >= 0 && super.pathX[0] < 104 && super.pathY[0] >= 0 && super.pathY[0] < 104) { // L: 251
				if (var3 == MoveSpeed.field2122) {
					Archive.method5586(this, var1, var2, MoveSpeed.field2122); // L: 253
				}

				this.move(var1, var2, var3); // L: 254
			} else {

...
public class class363 {
	...
	static final void method6612(Actor var0) {
		...
		if (var0.spotAnimation != -1 && Client.cycle >= var0.spotAnimationStartCycle) { // L: 4859
		...
		if (var0.sequence != -1 && var0.sequenceDelay <= 1) { // L: 4889
			...
			if (var1.field2096 == 1 && var0.field1098 > 0 && var0.exactMoveArrive1Cycle <= Client.cycle && var0.exactMoveArrive2Cycle < Client.cycle) { // L: 4891 4892
			...
			if (var1 != null) { // L: 4900
				if (!var1.method3690() && var1.frameIds != null) { // L: 4901
					...
					if (var0.sequenceFrame >= var1.frameIds.length) { // L: 4908
						...
						++var0.currentSequenceFrameIndex; // L: 4910
						if (var0.currentSequenceFrameIndex >= var1.field2095) { // L: 4911
							var0.sequence = -1;
					...
					if (var0.sequenceFrame < var2) { // L: 4920
						...
						++var0.currentSequenceFrameIndex; // L: 4925
						if (var0.currentSequenceFrameIndex >= var1.field2095) { // L: 4926
							var0.sequence = -1;

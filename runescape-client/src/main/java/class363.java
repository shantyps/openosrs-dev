...
public class class363 {
	...
	static final void method6612(Actor var0) {
		...
		if (var0.sequence != -1 && var0.sequenceDelay <= 1) {
			...
			if (var1.field2096 == 1 && var0.field1098 > 0 && var0.exactMoveArrive1Cycle <= Client.cycle && var0.exactMoveArrive2Cycle < Client.cycle) {
			...
			if (var1 != null) {
				if (!var1.method3690() && var1.frameIds != null) {
					...
					if (var0.sequenceFrame >= var1.frameIds.length) {
						...
						if (var0.currentSequenceFrameIndex >= var1.field2095) {
							var0.sequence = -1;

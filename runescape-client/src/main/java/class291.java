...
public class class291 {
	...
	static final void drawEntities(int var0, int var1, int var2, int var3) {
		...
		if (Client.cameraShaking[4] && Client.cameraMoveIntensity[4] + 128 > var4) { // L: 5197
		...
		for (var12 = 0; var12 < 5; ++var12) { // L: 5208
			if (Client.cameraShaking[var12]) { // L: 5209
				var13 = (int)(Math.random() * (double)(Client.cameraShakeIntensity[var12] * 2 + 1) - (double)Client.cameraShakeIntensity[var12] + Math.sin((double)Client.cameraShakeSpeed[var12] / 100.0D * (double)Client.cameraShakeCycle[var12]) * (double)Client.cameraMoveIntensity[var12]); // L: 5210
				if (var12 == 0) { // L: 5211

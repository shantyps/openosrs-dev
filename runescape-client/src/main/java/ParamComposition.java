...
public class ParamComposition extends DualNode {
	...
	static int method3397(int var0, Script var1, boolean var2) {
		if (var0 == ScriptOpcodes.SOUND_SYNTH) {
			...
			class315.playJingle(Interpreter.Interpreter_intStack[IsaacCipher.Interpreter_intStackSize], Interpreter.Interpreter_intStack[IsaacCipher.Interpreter_intStackSize + 1]);
			return 1;
		} else {
			int var3;
			int var4;

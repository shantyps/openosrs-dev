...
public class UserComparator10 extends AbstractUserComparator {
	...
	public static PlayerEquipmentItem method2609(int var0, Buffer var1) {
		int var2 = var1.readUnsignedByte(); // L: 24
		boolean var3 = (var2 & 1) != 0; // L: 25
		boolean var4 = (var2 & 2) != 0; // L: 26
		PlayerEquipmentItem var5 = new PlayerEquipmentItem(var0); // L: 27
		int var6;
		int[] var7;
		boolean var8;
		int var9;
		...
		if (var4) { // L: 43
			...
			var8 = var5.retextureTo != null && var7.length == var5.retextureTo.length; // L: 48

			for (var9 = 0; var9 < 2; ++var9) { // L: 49
				if (var7[var9] != 15) { // L: 50
					var10 = (short)var1.readUnsignedShort(); // L: 51
					if (var8) { // L: 52
						var5.retextureTo[var7[var9]] = var10; // L: 53
					}
				}
			}
		}

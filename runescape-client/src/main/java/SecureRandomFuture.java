...
public class SecureRandomFuture {
	...
	static final void method2025(int var0, int var1) {
		...
		if (UserComparator7.cameraPitch < var0) { // L: 4577
			UserComparator7.cameraPitch = (var0 - UserComparator7.cameraPitch) * ChatChannel.cameraLookAtAcceleration / 1000 + UserComparator7.cameraPitch + WorldMapSection1.cameraLookAtSpeed; // L: 4578
		...
		if (UserComparator7.cameraPitch > var0) { // L: 4581
			UserComparator7.cameraPitch -= (UserComparator7.cameraPitch - var0) * ChatChannel.cameraLookAtAcceleration / 1000 + WorldMapSection1.cameraLookAtSpeed; // L: 4582
		...
		if (var2 > 0) { // L: 4588
			class379.cameraYaw = class379.cameraYaw + WorldMapSection1.cameraLookAtSpeed + var2 * ChatChannel.cameraLookAtAcceleration / 1000; // L: 4589
			class379.cameraYaw &= 2047; // L: 4590
		}

		if (var2 < 0) { // L: 4592
			class379.cameraYaw -= -var2 * ChatChannel.cameraLookAtAcceleration / 1000 + WorldMapSection1.cameraLookAtSpeed; // L: 4593

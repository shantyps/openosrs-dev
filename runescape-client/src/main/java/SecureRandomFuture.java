...
public class SecureRandomFuture {
	...
	static final void method2025(int var0, int var1) {
		...
		if (UserComparator7.cameraPitch < var0) {
			UserComparator7.cameraPitch = (var0 - UserComparator7.cameraPitch) * ChatChannel.cameraLookAtAcceleration / 1000 + UserComparator7.cameraPitch + WorldMapSection1.cameraLookAtSpeed;
			if (UserComparator7.cameraPitch > var0) {
		...
		if (UserComparator7.cameraPitch > var0) {
			UserComparator7.cameraPitch -= (UserComparator7.cameraPitch - var0) * ChatChannel.cameraLookAtAcceleration / 1000 + WorldMapSection1.cameraLookAtSpeed;
			if (UserComparator7.cameraPitch < var0) {
				UserComparator7.cameraPitch = var0;
			}
		}
		...
		if (var2 > 0) {
			class379.cameraYaw = class379.cameraYaw + WorldMapSection1.cameraLookAtSpeed + var2 * ChatChannel.cameraLookAtAcceleration / 1000;
			class379.cameraYaw &= 2047;
		}

		if (var2 < 0) {
			class379.cameraYaw -= -var2 * ChatChannel.cameraLookAtAcceleration / 1000 + WorldMapSection1.cameraLookAtSpeed;
			class379.cameraYaw &= 2047;
		}

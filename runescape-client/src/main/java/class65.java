...
public class class65 {
	...
	static final void method1957(PacketBuffer var0, int var1, Player var2, int var3) {
		byte var4 = MoveSpeed.field2119.speed;
		int var5;
		int var6;
		int var8;
		int var9;
		...
		if ((var3 & 16384) != 0) {
			var2.exactMoveDeltaX1 = var0.method7396();
			var2.exactMoveDeltaY1 = var0.method7396();
			var2.exactMoveDeltaX2 = var0.method7397();
			var2.exactMoveDeltaY2 = var0.method7397();
			var2.exactMoveArrive1Cycle = var0.method7403() + Client.cycle;
			var2.exactMoveArrive2Cycle = var0.method7403() + Client.cycle;
			var2.exactMoveDirection = var0.method7499();
			if (var2.field1055) {
		...
		if ((var3 & 32) != 0) {
			...
			if (var2.username != null && var2.appearance != null) {
				...
				if (!var18 && Client.field590 == 0 && !var2.isHidden) {
					...
					var2.showPublicPlayerChat = var2 != class340.localPlayer && var19.isUser && "" != Client.field645 && var11.toLowerCase().indexOf(Client.field645) == -1;
		...
		if ((var3 & 1024) != 0) {
			MoveSpeed[] var15 = Players.field1246;
			MoveSpeed[] var21 = new MoveSpeed[]{MoveSpeed.field2120, MoveSpeed.field2123, MoveSpeed.field2122, MoveSpeed.field2119};
			var15[var1] = (MoveSpeed)class130.findEnumerated(var21, var0.method7465());
		}
		...
		if ((var3 & 64) != 0) {
			var2.facedDirection = var0.method7401();
		...
		if (var2.field1055) {
			if (var4 == 127) {
				...
				MoveSpeed var22;
				if (var4 != MoveSpeed.field2119.speed) {
					MoveSpeed[] var20 = new MoveSpeed[]{MoveSpeed.field2120, MoveSpeed.field2123, MoveSpeed.field2122, MoveSpeed.field2119};
					var22 = (MoveSpeed)class130.findEnumerated(var20, var4);
				} else {

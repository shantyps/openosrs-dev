...
public class class65 {
	...
	static final void method1957(PacketBuffer var0, int var1, Player var2, int var3) {
		byte var4 = MoveSpeed.field2119.speed; // L: 451
		int var5;
		int var6;
		int var8;
		int var9;
		...
		if ((var3 & 16384) != 0) { // L: 493
			var2.exactMoveDeltaX1 = var0.method7396(); // L: 494
			var2.exactMoveDeltaY1 = var0.method7396(); // L: 495
			var2.exactMoveDeltaX2 = var0.method7397(); // L: 496
			var2.exactMoveDeltaY2 = var0.method7397(); // L: 497
			var2.exactMoveArrive1Cycle = var0.method7403() + Client.cycle; // L: 498
			var2.exactMoveArrive2Cycle = var0.method7403() + Client.cycle; // L: 499
			var2.exactMoveDirection = var0.method7499(); // L: 500
			if (var2.field1055) { // L: 501
				var2.exactMoveDeltaX1 += var2.tileX; // L: 502
				var2.exactMoveDeltaY1 += var2.tileY; // L: 503
				var2.exactMoveDeltaX2 += var2.tileX; // L: 504
				var2.exactMoveDeltaY2 += var2.tileY; // L: 505
				var2.pathLength = 0; // L: 506
			} else {
				var2.exactMoveDeltaX1 += var2.pathX[0]; // L: 509
				var2.exactMoveDeltaY1 += var2.pathY[0]; // L: 510
				var2.exactMoveDeltaX2 += var2.pathX[0]; // L: 511
				var2.exactMoveDeltaY2 += var2.pathY[0]; // L: 512
		...
		if ((var3 & 32) != 0) { // L: 532
			...
			if (var2.username != null && var2.appearance != null) { // L: 538
				...
				if (!var18 && Client.field590 == 0 && !var2.isHidden) { // L: 543
					...
					var2.showPublicPlayerChat = var2 != class340.localPlayer && var19.isUser && "" != Client.field645 && var11.toLowerCase().indexOf(Client.field645) == -1; // L: 553
		...
		if ((var3 & 1024) != 0) { // L: 569
			MoveSpeed[] var15 = Players.field1246; // L: 570
			MoveSpeed[] var21 = new MoveSpeed[]{MoveSpeed.field2120, MoveSpeed.field2123, MoveSpeed.field2122, MoveSpeed.field2119}; // L: 574
			var15[var1] = (MoveSpeed)class130.findEnumerated(var21, var0.method7465()); // L: 576
		}

		if ((var3 & 2048) != 0) { // L: 578
			var2.spotAnimation = var0.method7499(); // L: 579
			var5 = var0.method7412(); // L: 580
			var2.spotAnimationHeight = var5 >> 16; // L: 581
			var2.spotAnimationStartCycle = (var5 & 65535) + Client.cycle; // L: 582
			var2.spotAnimationFrame = 0; // L: 583
			var2.spotAnimationFrameCycle = 0; // L: 584
			if (var2.spotAnimationStartCycle > Client.cycle) { // L: 585
		...
		if ((var3 & 64) != 0) { // L: 596
			var2.facedDirection = var0.method7401(); // L: 597
			if (var2.pathLength == 0) { // L: 598
				var2.orientation = var2.facedDirection; // L: 599
				var2.facedDirection = -1; // L: 600
			}
		}
		...
		if (var2.field1055) { // L: 617
			if (var4 == 127) { // L: 618
				...
				MoveSpeed var22;
				if (var4 != MoveSpeed.field2119.speed) { // L: 621
					MoveSpeed[] var20 = new MoveSpeed[]{MoveSpeed.field2120, MoveSpeed.field2123, MoveSpeed.field2122, MoveSpeed.field2119}; // L: 624
					var22 = (MoveSpeed)class130.findEnumerated(var20, var4); // L: 626
				} else {
